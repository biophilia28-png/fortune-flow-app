...
function UserHome({ profile, data, setTab, todayFortune }) {
  ...
  <div className="mt-2 text-xs text-slate-400">
    변효 {todayFortune.iching.changingLine}효
  </div>
  ...
  <div className="mt-3 text-xs leading-6 text-slate-300">
    {
      {
        "건위천":
          "강한 추진력과 시작의 기운입니다. 결단과 행동력이 중요합니다.",

        "곤위지":
          "억지로 밀어붙이기보다 안정과 인내가 중요한 흐름입니다.",

        "수뢰둔":
          "초반 장애가 강한 날입니다. 조급함을 줄이는 것이 좋습니다.",

        "산수몽":
          "판단 착오 가능성이 있습니다. 중요한 계약과 투자는 재확인하세요.",

        "수천수":
          "기다림 속에서 기회가 오는 흐름입니다. 타이밍이 중요합니다.",

        "천수송":
          "말다툼·충돌수 주의. 감정적 대응을 피하세요.",

        "지수사":
          "사람과 조직 속에서 힘이 생기는 날입니다.",

        "수지비":
          "귀인운과 인간관계 흐름이 좋습니다.",

        "풍천소축":
          "조금씩 쌓이는 운입니다. 성급함보다 축적이 중요합니다.",

        "천택리":
          "예의와 균형이 중요합니다. 과한 행동은 손실 가능성이 있습니다.",

        "지천태":
          "전체 흐름이 안정적이며 기회가 열리는 길괘입니다.",

        "천지비":
          "답답함과 정체 흐름이 강합니다. 무리한 추진은 불리합니다.",

        "천화동인":
          "협력·인맥·귀인운이 강합니다. 사람 속에서 기회가 생깁니다.",
        ...
        "뢰지예":
          "활동성과 외출운이 강합니다. 움직이면 기회가 생깁니다.",

        "택뢰수":
          "즐거움 속 실수가 생길 수 있습니다. 과소비·과욕 주의.",

        "산풍고":
          "정리·수리·재정비가 필요한 흐름입니다.",
