...
const ICHING_HEXAGRAMS = [
  "건위천","곤위지","수뢰둔","산수몽","수천수","천수송","지수사","수지비",
  "풍천소축","천택리","지천태","천지비","천화동인","화천대유","지산겸","뢰지예",
  "택뢰수","산풍고","지택림","풍지관","화뢰서합","산화비","산지박","지뢰복",
  "천뢰무망","산천대축","산뢰이","택풍대과","중수감","중화리","택산함","뢰풍항",
  "천산돈","뢰천대장","화지진","지화명이","풍화가인","화택규","수산건","뢰수해",
  "산택손","풍뢰익","택천쾌","천풍구","택지췌","지풍승","택수곤","수풍정",
  "택화혁","화풍정","중뢰진","간위산","풍산점","뢰택귀매","뢰화풍","화산려",
  "중풍손","중택태","풍수환","수택절","풍택중부","뢰산소과","수화기제","화수미제"
];
