...
export default function LifeFortunePage({ profile }) {
  ...
  <div className="mt-4 grid gap-3 md:grid-cols-2">
    ...
    <Card title="좋은 방향">
      ...
      <Section title="귀인·살 자동 해석">
  <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
    <Card title="천을귀인">
      어려울 때 도움을 주는 사람, 해결책, 보호운을 의미합니다.
      막힌 일이 있을 때 혼자 버티기보다 도움을 요청하면 좋습니다.
    </Card>

    <Card title="문창귀인">
      공부, 문서, 자격증, 글쓰기, 기획력과 관련된 귀인입니다.
      기록·정리·분석을 할수록 운이 살아납니다.
    </Card>

    <Card title="도화살">
      인기, 매력, 관심, 사람의 시선을 의미합니다.
      연애운에는 좋지만 감정소비와 구설수는 조심해야 합니다.
    </Card>

    <Card title="역마살">
      이동, 출장, 이사, 변화, 외부활동 기운입니다.
      가만히 있기보다 움직일 때 기회가 생길 수 있습니다.
    </Card>

    <Card title="화개살">
      고독, 몰입, 예술, 종교, 깊은 생각의 기운입니다.
      혼자 집중하는 일에서 성과가 나기 쉽습니다.
    </Card>

    <Card title="백호살">
      강한 에너지와 돌발 변수를 의미합니다.
      사고, 수술, 다툼, 급한 결정은 특히 조심하는 편이 좋습니다.
    </Card>
  </div>
</Section>

<Section title="돈 터지는 시기">
  <div className="grid gap-3 md:grid-cols-2">
    <Card title="재물 상승기">
      재물운은 한 번에 크게 터지는 구조보다 누적형으로 커지는 흐름입니다.
      작은 수익을 반복해서 쌓는 구조가 가장 안정적입니다.
    </Card>

    <Card title="사업운 강한 시기">
      작게 테스트하고 반응을 확인한 뒤 키우는 방식이 좋습니다.
      무료 사용자 확보 → 광고 → 소액 유료 기능 순서가 유리합니다.
    </Card>

    <Card title="투자 위험 시기">
      손실을 만회하려는 매매, 미수, 신용, 대출 투자는 가장 위험합니다.
      수익보다 먼저 손실 제한 기준을 잡아야 합니다.
    </Card>

    <Card title="돈 새는 패턴">
      지인 추천, 감정적 소비, 급등주 추격, 충동 결제가 손실 흐름을 만듭니다.
      돈이 들어오는 시기일수록 지출 통제가 중요합니다.
    </Card>
  </div>
</Section>

<Section title="AI 질문형 운세">
  <div className="grid gap-3 md:grid-cols-2">
    <Card title="올해 투자운은?">
      올해 투자운은 기회와 위험이 같이 들어오는 흐름입니다.
      분할매수, 손절 기준, 현금 비중을 지키면 손실 흐름을 줄일 수 있습니다.
    </Card>

    <Card title="언제 돈운이 강해지나?">
      월별 흐름에서 점수가 높은 달을 중심으로 재물운이 강해집니다.
      강한 달에는 확장보다 수익 실현과 관리가 더 중요합니다.
    </Card>

    <Card title="연애운 좋은 시기는?">
      인연운은 빠른 만남보다 오래 검증되는 관계에서 안정됩니다.
      감정적으로 끌리는 인연보다 신뢰가 쌓이는 인연이 유리합니다.
    </Card>

    <Card title="이직·사업운은?">
      준비 없이 움직이기보다 기존 기반을 정리한 뒤 움직이는 것이 좋습니다.
      계약, 문서, 돈 문제는 반드시 확인 후 진행해야 합니다.
    </Card>
  </div>
</Section>
